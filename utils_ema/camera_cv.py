...
class Intrinsics:
    ...
    def _points_to_normalized_grid(self, points: torch.Tensor) -> torch.Tensor:
        ...
        """
        W = self.resolution[..., 1].unsqueeze(-1)
        H = self.resolution[..., 0].unsqueeze(-1)
    ...
    def change_due_to_crop(
        ...
        res_diff_x = crop_offset[0] / self.pixel_unit_ratio()
        res_diff_y = crop_offset[1] / self.pixel_unit_ratio()
